package com.obtenerdiploma.util.repository;
...
public class StudentRepositoryTest {
    ...
    StudentRepository repository = new StudentRepository(Set.of(student1,student2));


    @Test
    @DisplayName("Test01: findAll ok")
    public void findAllTest(){
        //ARRANGE
        Set<Student> listaEsperada = Set.of(student1,student2);

        //ACT
        Set<Student> listaObtenida = repository.findAll();

        //ASSERT
        Assertions.assertEquals(listaEsperada,listaObtenida,"las listas no coinciden");
    ...
    public void testFindByIdTestOK() {
        ...
        //ACT
        Optional<Student> studentObtenido = repository.findById(idDeEntrada);
    ...
    public void testExistsTestOK() {
        ...
        //ACT
        boolean studentObtenido = repository.exists(student2);
    ...
    public void testExistsTestFAIL() {
        ...
        //ACT & ASSERT
        Assertions.assertThrows(StudentNotFoundException.class, () -> repository.exists(studentDeEntrada));
    }
}
