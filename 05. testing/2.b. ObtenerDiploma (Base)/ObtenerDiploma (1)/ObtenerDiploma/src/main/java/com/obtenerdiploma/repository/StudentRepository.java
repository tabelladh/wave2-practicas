...
public class StudentRepository implements IStudentRepository {
    ...
    public StudentRepository(Set<Student> studentOne) {
        loadData();
    }
...
//    @Override
//    public boolean update(Student updatedStu) {
//        try {
//            Optional<Student> existingStudent = this.findById(updatedStu.getId());
//
//            if (existingStudent.isEmpty()) {
//                throw new StudentNotFoundException(updatedStu.getId());
//            }
//
//            this.delete(updatedStu.getId());
//            return this.save(updatedStu);
//        } catch (StudentNotFoundException e) {
//            // Handle the exception if needed
//            e.printStackTrace();
//            return false; // Return false indicating the update failed
//        }
//    }
