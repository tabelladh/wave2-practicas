...
public class Main {
    public static void main(String[] args) {
        ...
        //Ejercicio 1 Una tienda de ropa compra sus productos de 3 fábricas distintas distribuidas por el pais
        ...
        System.out.println("Ingrese a que diarios esta suscrito:");
        for (int i = 1; i <= 50; i++) {
            System.out.println("Persona " + i + ":");
            System.out.print("¿Está suscrito al Diario A? (s/n): ");
            char respuestaA = scanner.next().charAt(0);
            System.out.print("¿Está suscrito al Diario B? (s/n): ");
            char respuestaB = scanner.next().charAt(0);
            System.out.print("¿Está suscrito al Diario C? (s/n): ");
            char respuestaC = scanner.next().charAt(0);

            if (respuestaA == 's') suscriptosA++;
            if (respuestaB == 's') suscriptosB++;
            if (respuestaC == 's') suscriptosC++;
            if (respuestaA == 's' && respuestaB == 's') suscriptosAB++;
            if (respuestaA == 's' && respuestaC == 's') suscriptosAC++;
            if (respuestaB == 's' && respuestaC == 's') suscriptosBC++;
            if (respuestaA == 's' && respuestaB == 's' && respuestaC == 's') suscriptosABC++;
        }

        System.out.println("\nResultados de la encuesta:");
        System.out.println("Personas suscriptas al Diario A: " + suscriptosA);
        System.out.println("Personas suscriptas al Diario B: " + suscriptosB);
        System.out.println("Personas suscriptas al Diario C: " + suscriptosC);
        System.out.println("Personas suscriptas a los 3 diarios: " + suscriptosABC);
        System.out.println("Personas suscriptas al Diario A y al Diario B: " + suscriptosAB);
        System.out.println("Personas suscriptas al Diario A y al Diario C: " + suscriptosAC);
        System.out.println("Personas suscriptas al Diario B y al Diario C: " + suscriptosBC);
        System.out.println("Personas suscriptas solo al Diario A: " + suscriptosA);
    }
}