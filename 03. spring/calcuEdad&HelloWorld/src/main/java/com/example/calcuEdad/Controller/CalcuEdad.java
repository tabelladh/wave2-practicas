...
import com.example.calcuEdad.Service.CalcuEdadService;
...
public class CalcuEdad {
    ...
    @Autowired
    private CalcuEdadService calcuEdadService;
    ...
    public Integer calcuEdad(@PathVariable Integer diaNacimiento,
                               @PathVariable Integer mesNacimiento,
                               @PathVariable Integer anioNacimiento){
        return calcuEdadService.calcuEdad(diaNacimiento,mesNacimiento,anioNacimiento);
    }
